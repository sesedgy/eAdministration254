...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__http_service__ = __webpack_require__(44);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_api_user_service__ = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__services_http_service__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__services_api_user_service__ = __webpack_require__(43);
...
var AccountSettingsComponent = (function () {
    ...
    AccountSettingsComponent.prototype.changeEmail = function () {
        var _this = this;
        this.userService.isLoginAndEmailFree(null, this.user.Email).subscribe(function (response) {
            if (response.json()[1]) {
                _this.userService.changeEmail(_this.user.Login, _this.user.Email).subscribe(function (response) {
    ...
    AccountSettingsComponent.prototype.changeLogin = function () {
        ...
        this.userService.isLoginAndEmailFree(null, this.user.Email).subscribe(function (response) {
            if (response.json()[0]) {
                _this.userService.changeLogin(_this.user.Email, _this.user.Login).subscribe(function (response) {
                    if (response.status === 200) {
                        $.gritter.add({
    ...
    AccountSettingsComponent.prototype.changePassword = function () {
        if (this.newPassword === this.newPasswordRepeat) {
            ...
            this.userService.changePassword(this.user.Login, this.newPassword).subscribe(function (response) {
                if (response.status === 200) {
                    $.gritter.add({
...
AccountSettingsComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_3__services_api_user_service__["a" /* UserService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__services_api_user_service__["a" /* UserService */]) === "function" && _a || Object])
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_http_service__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_cookie_service__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_router__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_api_user_service__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__appSettings__ = __webpack_require__(53);
